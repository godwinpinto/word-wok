            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 gap-x-12 w-full">
                            ...
                            <form class="space-y-6" action="#">
                                <div>
                                    ...
                                    <textarea id="message" rows="10" disabled
                                        ...
                                        placeholder="Your existing content would be displayed here in readonly mode, if it exits in Square">{{ itemRoot.itemData.description }}</textarea>
                                </div>
                                <div>
                                    <label for="password"
                                    ...
                                    <div class="text-xs text-zinc-600">Example: Fresh Lime, Soda, Sugar, Refereshing...</div>
                        ...
                        <div>
                            <span class="font-medium">Success!</span> Description updation is successful.
                        </div>
                    </div>
                                <button type="button" @click="updateToSquare"
                                    ...
                                    Update this description to Square
                                </button>
                            </form>
                        </div>
                    </div>
